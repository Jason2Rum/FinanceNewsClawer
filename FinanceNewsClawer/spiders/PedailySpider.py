...
class PedailySpider(scrapy.Spider):
  ...
  def parse_list(self, response):
    ...
    url_list = selector.xpath('//*[@id="firstnews-list"]/ul[position()>=1]/li/h3/a/@href').extract()
  ...
  def parse(self, response):
    ...
    time = selector.xpath('//*[@class="date"]/text()').extract_first()
    # time += ":00"
